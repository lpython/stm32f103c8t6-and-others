...
disky=`df | grep CPLAYBTBOOT | cut -d" " -f1`
sudo umount /Volumes/CPLAYBTBOOT
sudo mkdir /Volumes/CPLAYBTBOOT
sleep 2
sudo mount -v -o noasync -t msdos $disky /Volumes/CPLAYBTBOOT